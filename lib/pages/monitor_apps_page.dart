        ...
        children: [
          ...
          if (!_isLoadingApps)
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    '${filtered.length} 个应用 · 已选 $filteredEnabled 个',
          ...
          Expanded(
            child: _isLoadingApps
                ? const Center(child: Text('正在加载应用列表...', style: TextStyle(color: Colors.grey)))
                : filtered.isEmpty
                    ? const Center(child: Text('没有找到匹配的应用', style: TextStyle(color: Colors.grey)))
                    : ListView(
                        children: [
                          // 用户应用
